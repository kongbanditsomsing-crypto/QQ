...
const randomMessages = [
  "# @everyoneจะวัดอะไรก็ได้เเต่ไม่ใช่วัดเรื่องวาสนามึงไปหาหมอได้เลยกูว่าสมองมึงมีปัญหาเเละเงินกูมีเป็นปึกเเม่งใช้ไม่หมดเเละโครตจะหนาเเล้วพวกกูเกิดที่ISREALถ้ามึงข้องใจก็เข้ามาหากูต่อให้มึง7ร้อย7ข้ามกี่100กี่ข้ามมหาสมุทรมึงก็ยังตามพวกกูไม่ทันเพราะรัศมีกูสูงที่สุดกูมีทุกอย่างที่มึงต้องการกูมีทุกอย่างที่มึงไม่มีเเล้วมึงอย่าหวังจะเทียบกูได้ถ้าพวกมึงเป็นเเค่วันนาบีปักธงน้ำเงินขึ้นกลางอร่ามลมหนาวสีครามเหนือเเสงขยายหยงชุนไปทั่วทวีปให้ชื่อเสียงกูอยู่ทั่วทุกที่เขาบอกว่ากูเป็นNever dieเเต่กูจะตายเเละฟื้นคืนชีพเเละเข็มกัดเเชมป์มันอยู่ที่เอวเพราะพวกกูคือwinterfell",
