...
/* 🔥 แก้เพราะมึงเรียกใช้ randomMessages แต่ไม่ได้ประกาศ */
...
___________________________________
    ...
    if (interaction.commandName === "emoji") {
      ...
      await interaction.reply({
        content: "เริ่มยิงอีโมจิเเล้วไอ้คนน่ายักก",
        ephemeral: true,
      });
    ...
    if (interaction.commandName === "join") {
      ...
      if (!channel) {
        return interaction.reply({
          content: "มึงต้องอยู่ในห้องเสียงก่อนไอ้สัส",
          ephemeral: true,
        });
      }
    ...
    /* 🔥 ของเดิมที่มึงมี — โยกเข้า command เดียว เพื่อไม่ให้มันรันทุกที */
